...
import 'package:shop/screens/categories/clothes/clothes_category.dart';
import 'package:shop/screens/categories/clothes/man/man_category.dart';
...
import 'package:shop/screens/sellers/seller_page.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case clothesCategoryScreenRoute:
      return MaterialPageRoute(
        builder: (context) => const ClothesCategory(),
      );
    case manCategoryScreenRoute:
      return MaterialPageRoute(
        builder: (context) => const ManCategory(),
      );
    case sellerPageScreenRoute:
      return MaterialPageRoute(
